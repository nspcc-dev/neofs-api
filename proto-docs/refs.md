...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| key | [bytes](#bytes) |  | Public key used for signing. Content depends on `scheme`, for ECDSA schemes it's 33-byte compressed 256r1 ECDSA key, for N3 scheme it's a NeoVM verification script. The maximum allowed length is 1024 bytes. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| key | [bytes](#bytes) |  | Public key used for signing. See Signature for details. |
